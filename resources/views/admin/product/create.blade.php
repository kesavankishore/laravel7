...
<div class="content-area py-1">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="text" value="{{ old('code') }}" name="code"  id="code" placeholder="Code">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="number" name="stock" value="{{old('stock')}}" id="stock" placeholder="stock">
    </div>
  </div>
