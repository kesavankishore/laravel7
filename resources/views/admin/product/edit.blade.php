...
<div class="content-area py-1">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="text" value="{{ $product->code }}" name="code"  id="code" placeholder="Code">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="text" value="{{ $product->name }}" name="name"  id="name" placeholder="Name">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="number" name="price" value="{{ $product->price }}" id="price" placeholder="price">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="number" name="stock" value="{{ $product->stock }}" id="stock" placeholder="stock">
    </div>
  </div>
